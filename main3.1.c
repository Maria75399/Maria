...
//slave.
SPI_Init( SPI_FIRSTBIT_LSB, SPI_BaudRatePrescaler_2, SPI_Mode_Slave, SPI_Clock_Polarity, SPI_CPHA_1Edge, SPI_DATADIRECTION_2LINES_FULLDUPLEX, SPI_NSS_SOFT, 7);
//SPI.
SPI_Cmd(SPI1, ENABLE);
while(1){

if(GPIO_ReadInputPin(GPIOB, GPIO_Pin_7)){ GPIO_WriteLow( GPIOD, GPIO_Pin_0); SPI_SendData(111);}
